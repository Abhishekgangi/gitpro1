...
INSERT INTO message VALUES
 ...
 create table transaction (
    ...
    `senderBIC` VARCHAR(4) default NULL,
    `receiverBIC` VARCHAR(4) default NULL,
    `receiverAccountHolderName` VARCHAR(4) default NULL,
    `receiverAccountHolderNumber` VARCHAR(4) default NULL,
    `messageCode` VARCHAR(4) default NULL,
    `transferTypeCode` VARCHAR(4) default NULL,
    `transferDate` VARCHAR(4) default NULL,
